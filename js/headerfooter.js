...
<article class="header_inner">
  ...
  <nav class="nomalNav">
    ...
    <ul class="nav-links">
      ...
      <li><a href="allCategories.html">전체 카테고리</a></li>
...
<a href="../index.html"><img src="../img/logo/logotype03_c1green.svg" alt="logo"
      ...
      <div class="col">
        ...
        <div class="footer-content">
          <ul>
            ...
            <li>
              <a class="about" href="#"><i class="fa-solid fa-location"></i>서울시 강동구 고덕로 </a>
            </li>
            <li>
              <a class="about" href="#"><i class="fa-solid fa-phone"></i>00-0000-0000</a>
            </li>
            <li>
              <a class="about" href="#"><i class="fa-solid fa-envelope"></i>support@jcyorisa.com</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="social">
        <ul>
          <li>
            <a href="#"><a href="https://www.facebook.com/home.php" target="_blank"><i
